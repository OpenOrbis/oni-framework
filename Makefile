...
CFLAGS	:= $(I_DIRS) -D_DEBUG -D_KERNEL=1 -D_STANDALONE -D"ONI_PLATFORM=${ONI_PLATFORM}" -D__LP64__ -D_M_X64 -D__amd64__ -std=c11 -O0 -m64 -fpic -fno-builtin -nodefaultlibs -nostdlib -nostdinc -fcheck-new -ffreestanding -fno-strict-aliasing -fno-exceptions -fno-asynchronous-unwind-tables -Wall -Werror -Wno-unknown-pragmas
...
LFLAGS	:= $(L_DIRS) -shared -nodefaultlibs -nostdlib -Xlinker -T link.x
